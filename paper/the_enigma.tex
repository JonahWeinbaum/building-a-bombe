...
\begin{figure}[H]
  ...
  \begin{minipage}{0.48\textwidth}
    ...
    \subcaption{Disassembled rotor~\cite{Enigma_rotor_exploded_view}}
  \end{minipage}%
  \hfill
  \begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=0.8\linewidth]{paper/images/entry.jpg}
    \subcaption{Enigma rotor \texttt{V} entry side~\cite{Enigma_rotor_pin_contacts}}
    \vspace{4mm} % adjust spacing as needed
    \includegraphics[width=0.8\linewidth]{paper/images/exit.jpg}
    \subcaption{Enigma rotor \texttt{V} exit side~\cite{Enigma_rotor_flat_contacts}}
  \end{minipage}
  ...
  \begin{center}
    \resizebox{0.98\textwidth}{!}{
      \begin{tabular}{|c|c|c|c|c|}
        ...
        III}                                         & \texttt{10 14
        02}                                          & \texttt{BF SD
        AY QN LP JE}                                          & \texttt{VAR}
        \\
        \texttt{30.}                                 & \texttt{I II
        III}                                         & \texttt{04 25
        01}                                          & \texttt{UE PL
        AY IN QR SZ}                                          & \texttt{PAQ}
        \\
        \texttt{29.}                                 & \texttt{I II
        III}                                         & \texttt{13 11
        06}                                          & \texttt{WJ VD
        PO TY BL NK}                                          & \texttt{ZJB}
        \\
        $\vdots$                                     & $\vdots$
        & $\vdots$      & $\vdots$ & $\vdots$ \\
        \hline
