...
\begin{lemma}
  ...
  $\pi_i\pi_{i+3}$ of equal length~\cite[p.~8]{Rejewski1980}.
\end{lemma}
\begin{proof}
...
method}}~\cite[pp.~221--222]{Rejewski1980} and required tedious work and had many possibilities for
...
method}}~\cite[p.~223]{Rejewski1980}. The clock method attempted to determine where the turnover
