...
could be recovered as in Section~\ref{cyclometer_ring_setting} before by using known plain-text from
the message. 
...
window setting in plain-text and proceeded to encode their message key
