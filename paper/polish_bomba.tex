...
\begin{itemize}
	...
	\item Letters forming trigrams on the Enigma keyboard such as \texttt{ASD} and \texttt{PYX}. These were also later prohibited.
	      % https://archive.org/details/enigmahowgermanm0000koza/page/240/mode/2up PG 241 %
...
setting\footnote{Much like earlier cillies, some operators lazily chose trigrams for their ground setting and message key which formed words like \texttt{BERLIN} or \texttt{LONDON}}. % \begin{figure}[h]
%   \begin{center}
