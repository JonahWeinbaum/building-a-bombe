...
particular cipher-text was. Suppose we received three hexagrams
...
Equipped with a means to determine each day's $\sigma_i$s, Rejewski set
...
We now have deduced all of the rotor permutations $N$, $M$, $L$, $R$, as well as each
...
\subsection{Recovering the Ring Setting}
...
could be recovered as discussed before by using known plain-text from
