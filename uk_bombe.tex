...
% \begin{definition}
%     Given $\sigma\in S_n$, let 
%     \begin{center}
%         $\Sigma\coloneq\{\sigma^i\text{ }\vert\text{ }i\in\mathbb{N}_n\}$
%     \end{center}
%     that is $\Sigma = \langle\sigma\rangle \le S_n$ is the subgroup generated by $\sigma$.
% \end{definition}

% This subgroup of the symmetric group admits a group action by simply acting the permutation on an element, that is

% \begin{definition}
%     Given $\sigma\in S_n$ let 
%     \begin{align*}
%         \cdot : \Sigma\times\mathbb{N}_n&\to\mathbb{N}_n
%         \\(\rho, a)&\mapsto \rho(a)
%     \end{align*}
% \end{definition}
