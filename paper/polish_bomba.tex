...
\begin{itemize}
  ...
  \item Schlüsselanleitung für die Chiriermaschine Enigma -- A manual
...
Asché. In fact, through Asché, Langer had recieved key sheets which
...
Langer knew that war was looming and there would come a time where
...
of deriving the daily keys, not through intellegence, but through cryptanalysis.
...
encryption procedure outlined in \ref{protocol}. Operator Alice has
...
We can then compare these message keys against our possibilities for
